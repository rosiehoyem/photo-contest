  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved round as @round" do
        ...
        post :create, {:round => { "number" => "invalid value" }}, valid_session
        assigns(:round).should be_a_new(Round)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested round" do
        ...
        Round.any_instance.should_receive(:update).with({ "number" => "1" })
        put :update, {:id => round.to_param, :round => { "number" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the round as @round" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Round.any_instance.stub(:save).and_return(false)
        put :update, {:id => round.to_param, :round => { "number" => "invalid value" }}, valid_session
        assigns(:round).should eq(round)
      end
